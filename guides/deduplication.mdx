...
description: "How claude-real-video drops near-duplicate frames with sliding-window RGB pixel difference, so repeated shots and A-B-A cutaways never reach the LLM twice."
---
