...
description: "claude-real-video uses existing subtitles first — sidecar .srt/.vtt or embedded streams — then falls back to Whisper only when none are found."
---
