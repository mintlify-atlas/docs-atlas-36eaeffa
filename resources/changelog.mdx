---
title: "claude-real-video Changelog"
sidebarTitle: "Changelog"
description: "Release history for claude-real-video. Track new features, bug fixes, and breaking changes across versions."
---
...
Earlier releases introduced the core pipeline: `yt-dlp`-based URL fetching, `ffmpeg` scene-change extraction, pixel-difference deduplication, and Whisper transcription. These versions are available on PyPI. For detailed history, refer to the [GitHub repository](https://github.com/HUANGCHIHHUNGLeo/claude-real-video).
